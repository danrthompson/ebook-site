		...
		<div id="portfolio-filter-wrapper" class="clearfix">
			...
			?>
				...
				<div class="right-float">
					<a href="#filter-hide" class="togglefilter" title="Filter Work"><i class="icon-reorder"></i></a> <a href="<?php echo esc_url('' .get_theme_mod( 'theme_customizer_linktoportfolio', '' )."\n");?>" class="fullportfolio" title="Full Portfolio"><i class="icon-heart"></i></a>
				</div>
		</div>
			<div id="portfolio-wrapper">
			<?php
				$loop = new WP_Query(array('post_type' => 'project', 'posts_per_page' => 6));
				$count =0;
			?>
