			...
			<div class="content block ebook_pg">
				...
				<div class="why_pg_central_content">
					...
					<div class="half right-float top-margin">
						<h5 id="left-float"> Start Learning With Our</h5>
						<h5><span class="teal thick-title left-float">EBOOK</span></h5>
			...
			<div class="content block ebook_pg">
				...
				<div class="why_pg_central_content">
					...
					<div class="half left-float top-margin">
						<h5 class="text-right"> Start Doing With Our</h5>
						<h5><span id="blue" class="thick-title right-float">TOOLKIT</span></h5>
